...
function modBuild() 
{
    ...
    Pkg.makePrologue += "release: resMgr_document_generation\n";
    Pkg.makePrologue += "resMgr_document_generation:\n";
    Pkg.makePrologue += "\t @echo ----------------------------\n";
    Pkg.makePrologue += "\t @echo Generating Resource Manager Documentation\n";
    Pkg.makePrologue += "\t doxygen docs/Doxyfile\n";
    Pkg.makePrologue += "\t @echo Resource Manager Documentation Generated \n";
    Pkg.makePrologue += "\t @echo ----------------------------\n";
