...
function modBuild() 
{
    ...
    Pkg.makePrologue += "release: dat_document_generation\n";
    Pkg.makePrologue += "dat_document_generation:\n";
    Pkg.makePrologue += "\t @echo ----------------------------\n";
    Pkg.makePrologue += "\t @echo Generating Dat Documentation\n";
    Pkg.makePrologue += "\t doxygen docs/Doxyfile\n";
    Pkg.makePrologue += "\t @echo Dat Documentation Generated \n";
    Pkg.makePrologue += "\t @echo ----------------------------\n";
