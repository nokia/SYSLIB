 ...
 *      Not Applicable
 */
void Msgcom_listInit (Msgcom_ListObj* ptrList)
{
 ...
 *      0	-	List
 */
int32_t Msgcom_isListEmpty (Msgcom_ListObj* ptrList)
{
    if (ptrList->count == 0)
        return 1;
    return 0;
 ...
 *      Not Applicable.
 */
void Msgcom_listEnqueue (Msgcom_ListObj* ptrList, Msgcom_ListNode* ptrListNode)
{
    Msgcom_ListNode*   ptrPrev;
 ...
 */
Msgcom_ListNode* Msgcom_listDequeue (Msgcom_ListObj* ptrList)
{
    Msgcom_ListNode*   ptrListNode;

    /* Is the list empty? */
    if (Msgcom_isListEmpty(ptrList))
        return NULL;
 ...
 *      Head of the list (NULL if the list was empty)
 */
Msgcom_ListNode* Msgcom_listGetHead (Msgcom_ListObj* ptrList)
{
    /* Is the list empty? */
    if (Msgcom_isListEmpty(ptrList))
        return NULL;
 ...
 */
Msgcom_ListNode* Msgcom_listGetNext (Msgcom_ListObj* ptrList, Msgcom_ListNode* ptrElement)
{
 ...
 *      Counter
 */
uint32_t Msgcom_listGetCount (Msgcom_ListObj* ptrList)
{
 ...
 *      Error       -   <0
 */
int32_t Msgcom_listRemoveElement (Msgcom_ListObj* ptrList, Msgcom_ListNode* ptrElement)
{
    Msgcom_ListNode*   ptrListNodeNext;
    Msgcom_ListNode*   ptrListNodePrev;
