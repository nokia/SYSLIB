...
# Source Files
ARM_TEST_SOURCES = test/arm/main.c test/arm/osal.c test/arm/reader.c test/arm/writer.c
...
# Executable
ARM_TEST_OUT     = test/arm/test_msgcom_$(SYSLIB_DEVICE).out
