...
function modBuild() 
{
    ...
    Pkg.makePrologue += "release: uintc_document_generation\n";
    Pkg.makePrologue += "uintc_document_generation:\n";
    Pkg.makePrologue += "\t @echo ----------------------------\n";
    Pkg.makePrologue += "\t @echo Generating UINTC Documentation\n";
    Pkg.makePrologue += "\t doxygen docs/Doxyfile\n";
    Pkg.makePrologue += "\t @echo UINTC Documentation Generated \n";
    Pkg.makePrologue += "\t @echo ----------------------------\n";
