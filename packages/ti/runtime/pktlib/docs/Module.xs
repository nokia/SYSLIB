/******************************************************************************
 * FILE PURPOSE: Packet Library DOCS Module specification file.
 ******************************************************************************
 * FILE NAME: module.xs
 *
 * DESCRIPTION: 
 *  This file contains the module specification for the Packet Library 
 *  Documentation.
 *
...
function modBuild() 
{
    ...
    Pkg.makePrologue += "release: pktLib_document_generation\n";
    Pkg.makePrologue += "pktLib_document_generation:\n";
    Pkg.makePrologue += "\t @echo ----------------------------\n";
    Pkg.makePrologue += "\t @echo Generating Packet Library Documentation\n";
    Pkg.makePrologue += "\t doxygen docs/Doxyfile\n";
    Pkg.makePrologue += "\t @echo Packet Library Documentation Generated \n";
    Pkg.makePrologue += "\t @echo ----------------------------\n";
    ...
    Pkg.otherFiles[Pkg.otherFiles.length++] = "docs/pktLib_SoftwareManifest.pdf";
    Pkg.otherFiles[Pkg.otherFiles.length++] = "docs/ReleaseNotes_pktLib.pdf";
}
