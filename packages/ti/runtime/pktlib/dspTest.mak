...
ifeq ($(ARM_DSP_DOWNLOAD),1)
	DSP_CORE0_MAP       =   $(DSP_CORE0_CONFIGPKG)/pktlib_dsp_core0_armdl.map
	DSP_CORE0_OUT       = 	$(DSP_CORE0_CONFIGPKG)/pktlib_dsp_core0_armdl.out
else
	DSP_CORE0_MAP       =   $(DSP_CORE0_CONFIGPKG)/pktlib_dsp_core0.map
	DSP_CORE0_OUT       = 	$(DSP_CORE0_CONFIGPKG)/pktlib_dsp_core0.out
endif
DSP_CORE0_SOURCES   = 	$(PKTLIB_LIB_SOURCES) 														\
...
dspCore0: dspCore0.cfg $(DSP_CORE0_OBJECTS)
		...
		@echo '******************************************************************************'
		@echo 'Built the PKTLIB DSP Core0 Executable '
		@echo '******************************************************************************'
...
ifeq ($(ARM_DSP_DOWNLOAD),1)
	DSP_CORE1_MAP       =   $(DSP_CORE1_CONFIGPKG)/pktlib_dsp_core1_armdl.map
	DSP_CORE1_OUT       = 	$(DSP_CORE1_CONFIGPKG)/pktlib_dsp_core1_armdl.out
else
	DSP_CORE1_MAP       =   $(DSP_CORE1_CONFIGPKG)/pktlib_dsp_core1.map
	DSP_CORE1_OUT       = 	$(DSP_CORE1_CONFIGPKG)/pktlib_dsp_core1.out
endif
DSP_CORE1_SOURCES   = 	$(PKTLIB_LIB_SOURCES) 														\
...
dspCore1: dspCore1.cfg $(DSP_CORE1_OBJECTS)
	...
	@echo '******************************************************************************'
	@echo 'Built the PKTLIB DSP Core1 Executable '
	@echo '******************************************************************************'
