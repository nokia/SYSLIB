...
DSP_CORE0_MAP       = 	$(DSP_CORE0_CONFIGPKG)/name_dsp_core0.map
DSP_CORE0_OUT       = 	$(DSP_CORE0_CONFIGPKG)/name_dsp_core0.out
DSP_CORE0_SOURCES   = 	$(NAME_LIB_SOURCES) $(NAME_DSP_SOURCES)										\
...
dspCore0: dspCore0.cfg $(DSP_CORE0_OBJECTS)
		...
		@echo '******************************************************************************'
		@echo 'Built the NAME DSP Core0 Executable '
		@echo '******************************************************************************'
...
DSP_CORE1_MAP       =   $(DSP_CORE1_CONFIGPKG)/name_dsp_core1.map
DSP_CORE1_OUT       = 	$(DSP_CORE1_CONFIGPKG)/name_dsp_core1.out
DSP_CORE1_SOURCES   = 	$(NAME_LIB_SOURCES) $(NAME_DSP_SOURCES)                                 	\
...
dspCore1: dspCore1.cfg $(DSP_CORE1_OBJECTS)
	...
	@echo '******************************************************************************'
	@echo 'Built the NAME DSP Core1 Executable '
	@echo '******************************************************************************'
