...
function modBuild() 
{
    ...
    Pkg.makePrologue += "release: name_document_generation\n";
    Pkg.makePrologue += "name_document_generation:\n";
    Pkg.makePrologue += "\t @echo ----------------------------\n";
    Pkg.makePrologue += "\t @echo Generating Name Documentation\n";
    Pkg.makePrologue += "\t doxygen docs/Doxyfile\n";
    Pkg.makePrologue += "\t @echo Name Documentation Generated \n";
    Pkg.makePrologue += "\t @echo ----------------------------\n";
