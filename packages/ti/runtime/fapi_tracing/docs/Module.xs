/******************************************************************************
 * FILE PURPOSE: FAPI Tracing DOCS Module specification file.
 ******************************************************************************
 * FILE NAME: module.xs
 *
 * DESCRIPTION: 
 *  This file contains the module specification for the FAPI Tracing
 *  Documentation.
 *
...
function modBuild() 
{
    ...
    Pkg.makePrologue += "release: fapi_tracing_document_generation\n";
    Pkg.makePrologue += "fapi_tracing_document_generation:\n";
    Pkg.makePrologue += "\t @echo ----------------------------\n";
    Pkg.makePrologue += "\t @echo Generating FAPI Tracing Documentation\n";
    Pkg.makePrologue += "\t doxygen docs/Doxyfile\n";
    Pkg.makePrologue += "\t @echo FAPI Tracing Documentation Generated \n";
    Pkg.makePrologue += "\t @echo ----------------------------\n";
