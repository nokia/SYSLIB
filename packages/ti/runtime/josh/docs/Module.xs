...
function modBuild() 
{
    ...
    Pkg.makePrologue += "release: josh_document_generation\n";
    Pkg.makePrologue += "josh_document_generation:\n";
    Pkg.makePrologue += "\t @echo ----------------------------\n";
    Pkg.makePrologue += "\t @echo Generating JOSH Documentation\n";
    Pkg.makePrologue += "\t doxygen docs/Doxyfile\n";
    Pkg.makePrologue += "\t @echo JOSH Documentation Generated \n";
    Pkg.makePrologue += "\t @echo ----------------------------\n";
