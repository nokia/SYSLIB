 ...
 *      Not Applicable
 */
void Josh_listAdd (Josh_ListNode **ptr_list, Josh_ListNode *ptr_node)
{
	Josh_ListNode*	ptr_head;
 ...
 *      Not Applicable
 */
void Josh_listCat (Josh_ListNode **ptr_dst, Josh_ListNode **ptr_src)
{
	Josh_ListNode*	ptr_node;
	Josh_ListNode*	ptr_prev;
 ...
 */
Josh_ListNode* Josh_listRemove (Josh_ListNode **ptr_list)
{
	Josh_ListNode*	ptr_head;
	Josh_ListNode*	ptr_node;
 ...
 *      Error   -   -1
 */
int32_t Josh_listRemoveNode (Josh_ListNode **ptr_list, Josh_ListNode *ptr_remove)
{
	Josh_ListNode*	ptr_next;
	Josh_ListNode*	ptr_prev;
 ...
 */
Josh_ListNode* Josh_listGetHead (Josh_ListNode **ptr_list)
{
	return *ptr_list;
}
 ...
 */
Josh_ListNode* Josh_listGetNext (Josh_ListNode *ptr_list)
{
