...
function modBuild() 
{
    ...
    Pkg.makePrologue += "release: root_document_generation\n";
    Pkg.makePrologue += "root_document_generation:\n";
    Pkg.makePrologue += "\t @echo ----------------------------\n";
    Pkg.makePrologue += "\t @echo Generating Root Documentation\n";
    Pkg.makePrologue += "\t doxygen docs/Doxyfile\n";
    Pkg.makePrologue += "\t @echo Root Documentation Generated \n";
    Pkg.makePrologue += "\t @echo ----------------------------\n";
