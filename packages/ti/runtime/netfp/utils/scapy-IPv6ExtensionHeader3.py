...
#
# The script is used to generate fragments in which the routing header is added before
# the fragmentation header and then a destination option header is added
#
...
#########################################################################################
frags = fragment6(IPv6(src=sip, dst=dip) / IPv6ExtHdrRouting() / IPv6ExtHdrFragment() / IPv6ExtHdrDestOpt(options=RouterAlert()) / ICMPv6EchoRequest(data='A'*1600), 1024)
for f in frags:
