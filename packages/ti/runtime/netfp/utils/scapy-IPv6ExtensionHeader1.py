...
#
# The script is used to generate fragments in which a routing header is added before the
...
#########################################################################################
frags = fragment6(IPv6(src=sip, dst=dip) / IPv6ExtHdrRouting() / IPv6ExtHdrFragment() /  ICMPv6EchoRequest(data='A'*1600), 1024)
for f in frags:
